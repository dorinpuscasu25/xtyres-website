...
export default function Security({
    ...
    const updatePassword = SecurityController.update();
    const disableTwoFactor = disable();
    const enableTwoFactor = enable();
                        ...
                        {twoFactorEnabled ? (
                            <div className="flex flex-col items-start justify-start space-y-4">
                                ...
                                <div className="relative inline">
                                    <Form
                                        action={disableTwoFactor.url}
                                        method={disableTwoFactor.method}
                                    >
                                        {({ processing }) => (
                                            <Button
                                                variant="destructive"
                            ...
                            <div className="flex flex-col items-start justify-start space-y-4">
                                ...
                                <div>
                                    {hasSetupData ? (
                                        ...
                                        <Form
                                            action={enableTwoFactor.url}
                                            method={enableTwoFactor.method}
                                            onSuccess={() =>
                                                setShowSetupModal(true)
                                            }
                                        >
